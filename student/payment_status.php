...
if (isset($_GET['refresh']) || isset($_POST['refresh_status'])) {
    verify_csrf();
    ...
    <div class="col-xl-8">
        <div class="card card-soft p-4">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6"><div class="border rounded-4 p-3 h-100"><div class="stat-muted">Reference</div><div class="fw-semibold"><?= e($payment['gateway_reference']) ?></div><div class="small text-muted mt-2">Gateway status: <?= e($payment['gateway_status'] ?: 'pending') ?></div></div></div>
            ...
            <div class="alert alert-info border-0">Approve the charge on your phone first. Then use the refresh button below until the payment switches to <strong>Paid</strong>.</div>
